...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
        <li><a class="nav-link scrollto active" href="create.php">Create</a></li>         
        ...
        <table   id="example" class="table table-striped table-bordered nowrap" style="width:100%">
            ...
            <?php while($row=mysqli_fetch_assoc($sql)){?>
                ...
                <tr>
                    ...
                    <td>
				<a href="edit.php?id=<?php echo $row['id']; ?>" class="edit_btn" ><i class="far fa-edit"></i></a>
		
      <a href="delete.php?id=<?php echo $row['id']; ?>" onclick='return confirm ("are you sur to delete");' class="delete" title="Delete" data-toggle="tooltip"><i class="far fa-trash-alt"></i></a>
      </td>
                </tr>
                <?php } ?>
